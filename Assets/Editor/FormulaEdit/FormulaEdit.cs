...
public class FormulaEdit : EditorWindow
{
    ...
    private void MkFormulaSelect()
    {
        ...
        this.selIdx = EditorGUILayout.Popup(DES_3, this.selIdx, FormulaEdit.GetFormulasNamesUnderType());
    ...
    private void MkFormulaParamForm(int idx)
    {
        ...
        else
        {
            ...
            {
                list = FormulaEdit.GetFormulasNamesUnderType();
    ...
    private void MkParamCondiction(int idx, int cIdx)
    {
        ...
        {
            list = FormulaEdit.GetFormulasNamesUnderType();
            list2 = FormulaEdit.GetFormulasNamesUnderType();
        }
