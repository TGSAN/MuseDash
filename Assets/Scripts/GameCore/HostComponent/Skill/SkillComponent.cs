...
namespace FormulaBase
{
    public class SkillComponent : CustomComponentBase
    {
        ...
        public FormulaHost CreateSkill(int skillId, FormulaHost host = null)
        {
            ...
            float tick = -1f;
            tick = ConfigManager.instance.GetConfigFloatValue(SKILL_CONFIG_NAME, "id", "time", skillId.ToString());
            ...
            string effectName = ConfigManager.instance.GetConfigStringValue(SKILL_CONFIG_NAME, "id", effectKey,
                   skillId.ToString());
            ...
            foreach (uint _condiction in resultConfigMap.Keys)
            {
                ...
                string _effName = ConfigManager.instance.GetConfigStringValue(SKILL_CONFIG_NAME, "id", _effKey,
                    skillId.ToString());
                if (_effName == null)
                {
                    continue;
        ...
        public void RemoveSkill(FormulaHost skillObject)
        {
            ...
            foreach (uint _condiction in resultConfigMap.Keys)
            {
                ...
                int _effId = ConfigManager.instance.GetConfigIntValue(SkillComponent.SKILL_CONFIG_NAME, "id",
                    resultConfigMap[_condiction], id.ToString());
        ...
        public void FireSkill(FormulaHost skillObject, uint condiction)
        {
            ...
            string effectId = ConfigManager.instance.GetConfigStringValue(SKILL_CONFIG_NAME, "id", configKey,
                skillId.ToString());
        ...
        private string GetActionKey(FormulaHost skillObject, uint condiction)
        {
            ...
            string actKey = ConfigManager.instance.GetConfigStringValue(SKILL_CONFIG_NAME, "id", strActKey,
                skillId.ToString());
            if (actKey.Length < 2)
            {
                return null;
