...
public class bagPanel2 : UIPanelBase {
	...
	BagStyle m_BagTable=BagStyle.BAG_SHOWALL;						//背包显示类型
	SortItemStyel m_ItemSort=SortItemStyel.ITEM_TIMESORT;			//排序方式
	List<List<ushort>> m_ComposeList=new List<List<ushort>>();		//组合链表
	List<GameObject> m_listbagEmpty=new List<GameObject>();			//背包空位
	...
	void SetEmpty(List<FormulaHost> temp)
	{
...
//
	List<GameObject> m_BagItem=new List<GameObject>();				 //UI显示的Ob 所有的物品
	/// <summary>
	/// 消耗的物品
	/// </summary>
