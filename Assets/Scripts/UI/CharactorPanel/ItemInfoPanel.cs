...
public class ItemInfoPanel : UIPanelBase
{
    ...
    private string FontBase = "[907BB0FF]";             //显示面板的两种字体颜色
    private string FontLevel = "[2BFC7AFF]";
    ...
    private LevelUpPanel m_LevelUpPanel = null;
    ...
    private void ShowItemInfo(int _hp = 0, int _def = 0, int _att = 0, int _crt = 0, int addhp = 0, int adddef = 0, int addatt = 0, int addcrt = 0)
    {
        if (_hp == 0)
        {
    ...
    private void ShowEquip(FormulaHost _host)
    {
    ...
    /// 判断装备是否满级
    /// </summary>
    private void FullLevelEquip()
    {
        m_UpgradeButton.SetActive(false);
    }

    private void NoFullLevelEquip()
    {
        m_UpgradeButton.SetActive(true);
    }
    ...
    private void ShowMaterial(FormulaHost _host)
    {
    ...
    /// </summary>
    /// <param name="_host">Host.</param>
    private void ShowPet(FormulaHost _host)
    {
    ...
    /// 点击升级按钮的回调
    /// </summary>
    private void ClickLevelUpCallBack(bool _success)
    {
        if (_success)
        {
    ...
    private void FullLevelPet()
    {
    }

    private void NoFullLevelPet()
    {
    }
    ...
    private IEnumerator PlayLevelUpFinishAnimation()
    {
