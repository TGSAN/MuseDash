...
//		int MoneyNumber=(int)SundryManageComponent.Instance.GetVaule(5+count);
//
//		if(AccountManagerComponent.Instance.ChangeDiamond(-MoneyNumber))
//		{
...
//		}
	...
	void ClicikUseMoneyBuyGridCallBack(bool _success)
	{
		Debug.Log ("使用钱的反馈");
	...
	void ClickCostMoneyBuyGridCallBack(bool _success)
	{
