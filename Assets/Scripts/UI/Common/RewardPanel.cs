...
public class RewardPanel : MonoBehaviour {
	...
	List<string > m_IconName=new List<string>();//显示物品的名字
	List<int> m_ListQuality=new List<int>();
	...
	public void PlaySHowItem()
	{
		...
		{
		case 1:m_Particle1.SetActive(true);
			m_QualitySprite.spriteName="common";
			break;
		case 2:m_Particle2.SetActive(true);
			m_QualitySprite.spriteName="rare";
			break;
		case 3:m_Particle3.SetActive(true);
			m_QualitySprite.spriteName="epic";
			break;
		case 4:m_Particle4.SetActive(true);
