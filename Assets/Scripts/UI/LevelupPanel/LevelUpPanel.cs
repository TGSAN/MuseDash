...
public class LevelUpPanel : UIPanelBase
{
    ...
    private FormulaHost m_ingoreHost = null;
    ...
    /// 设置金钱的消耗 和经验的获取
    /// </summary>
    private void SetCostMoneyAndExp()
    {
        int tempMoney = 0;
        int Exp = 0;
    ...
    private UIPerfabsManage.CallBackFun ClickSure = null;
    ...
    private IEnumerator StartAnimationReverse()
    {
        yield return 0;
        PanelClickBack();
    }
