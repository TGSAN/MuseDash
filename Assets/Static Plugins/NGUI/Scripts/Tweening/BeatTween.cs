...
//
//public class Test : UITweener {
//	public UITweener m_TweenArr222;
//	public UITweener[] m_TweenArr=new UITweener[4];
////	Test()
////	{
////		m_TweenArr=new UITweener[4];
////	}
//
//
...
/// </summary>
//public abstract class BeatTween : MonoBehaviour
//{
//	public Test[] arrttt=new Test[4];
//}
public abstract class BeatTween : MonoBehaviour
{
	/// <summary>
	...
	static public BeatTween current;
...
//	public Method method1 = Method.Linear;
//	public Method method2 = Method.Linear;
//	public Method method3 = Method.Linear;
//	public Method method4 = Method.Linear;
	/// <summary>
	...
	public AnimationCurve animationCurve1 = new AnimationCurve(new Keyframe(0f, 0f, 0f, 1f), new Keyframe(1f, 1f, 1f, 0f));
	public AnimationCurve animationCurve2 = new AnimationCurve(new Keyframe(0f, 0f, 0f, 1f), new Keyframe(1f, 1f, 1f, 0f));
	public AnimationCurve animationCurve3 = new AnimationCurve(new Keyframe(0f, 0f, 0f, 1f), new Keyframe(1f, 1f, 1f, 0f));
	public AnimationCurve animationCurve4 = new AnimationCurve(new Keyframe(0f, 0f, 0f, 1f), new Keyframe(1f, 1f, 1f, 0f));
	/// <summary>
	...
	public float duration3 = 1f;
	public float duration4 = 1f;
	...
	/// </summary>
//	public float amountPerDelta1
//	{
//		get
//		{
//			if (mDuration != duration1)
//			{
//				mDuration = duration1;
//				mAmountPerDelta = Mathf.Abs((duration1 > 0f) ? 1f / duration1 : 1000f) * Mathf.Sign(mAmountPerDelta);
//			}
//			return mAmountPerDelta;
//		}
//	}
//	public float amountPerDelta2
//	{
//		get
//		{
//			if (mDuration != duration2)
//			{
//				mDuration = duration2;
//				mAmountPerDelta = Mathf.Abs((duration2 > 0f) ? 1f / duration2 : 1000f) * Mathf.Sign(mAmountPerDelta);
//			}
//			return mAmountPerDelta;
//		}
//	}
//	public float amountPerDelta3
//	{
//		get
//		{
//			if (mDuration != duration3)
//			{
//				mDuration = duration3;
//				mAmountPerDelta = Mathf.Abs((duration3 > 0f) ? 1f / duration3 : 1000f) * Mathf.Sign(mAmountPerDelta);
//			}
//			return mAmountPerDelta;
//		}
//	}
//	public float amountPerDelta4
//	{
//		get
//		{
//			if (mDuration != duration4)
//			{
//				mDuration = duration4;
//				mAmountPerDelta = Mathf.Abs((duration4 > 0f) ? 1f / duration4 : 1000f) * Mathf.Sign(mAmountPerDelta);
//			}
//			return mAmountPerDelta;
//		}
//	}
//
	...
	static public T Begin<T> (GameObject go, float duration) where T : BeatTween
	{
